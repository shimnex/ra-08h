...
static void lwan_dev_params_update( void )
{
    ...
    //Configuration for TTN/Helium network
    //https://www.thethingsnetwork.org/docs/lorawan/frequency-plans/#us902-928
    //https://docs.helium.com/iot/lorawan-frequency-plans/#us915
    channelsMaskTemp[0] = 0xFF00; //channels 8-15 = subband2
    channelsMaskTemp[1] = 0x0000;
    channelsMaskTemp[2] = 0x0000;
    channelsMaskTemp[3] = 0x0000;
    channelsMaskTemp[4] = 0x0002; //channel 65
